    ...
    <Layout>
      ...
      <PrivacyBlock>
        <Container>
          ...
          <article>
            <h2>
              willread는 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을
            ...
            <h3>나. 개인정보 수집방법</h3>
            <p>willread는 다음과 같은 방법으로 개인정보를 수집합니다.</p>
            <p> – 생성정보 수집 도구를 통한 수집</p>
            <h2>2. 개인정보의 수집 및 이용목적</h2>
            <h3>가. 신규 서비스 개발 및 마케팅·광고에의 활용</h3>
            <p>
            ...
            <h2>4. 개인정보의 처리위탁</h2>
            <p>
              willread는 서비스 이용 및 통계 분석을 목적으로 Google에 개인정보를
              위탁하고 있습니다.
            </p>
            <h2>5. 개인정보의 보유 및 이용기간</h2>
            <p>
              willread는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이
              해당 정보를 지체 없이 파기합니다.
            </p>
            ...
            <p>
              ...
              탈퇴(서비스 이용 동의 철회)를 위해서는 willread에게 이메일
              통지의 방법 등을 이용할 수 있습니다.
            </p>
            <h2>7. 개인정보관리 책임자 및 담당자</h2>
            <p>
              willread는 개인정보에 대한 의견수렴 및 불만처리를 담당하는
